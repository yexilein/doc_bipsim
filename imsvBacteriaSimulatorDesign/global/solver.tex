...
The solving loop is depicted in~\reffigt{fig:solver}. The Gillespie algorithm has many variants. We decided to implement it using three \emph{abstract} classes. By using inheritance, variants can be implemented for each step of the algorithm and combined at will by the end user. The three central classes are:
\begin{itemize}
