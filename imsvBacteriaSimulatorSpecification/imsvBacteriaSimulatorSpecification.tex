...
\usepackage{amssymb}
\newcommand{\reactionRev}[4]{#1 \,\, \displaystyle{\mathop{\rightleftarrows}_{#4}^{#3}} \,\, #2}
\newcommand{\reactionIrr}[4]{#1 \,\, \displaystyle{\mathop{\rightarrow}^{#3}} \,\, #2} % For compatibility with reactionRev
