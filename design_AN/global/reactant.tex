...
hierarchy~\reffigp{fig:reactant_uml}.
...
\texttt{Chemical} is an abstract class~\reffigp{fig:chemical}.
...
\texttt{FreeChemical}~\reffigp{fig:free_chemical} is a subclass of \texttt{Chemical}
...
\texttt{BoundChemical}~\reffigp{fig:bound_chemical} is a subclass of \texttt{Chemical}
...
\texttt{ChemicalSequence}~\reffigp{fig:chemical_sequence} is a subclass of \texttt{FreeChemical}.
...
\texttt{BindingSiteFamily}~\reffigp{fig:bsf} is a subclass of \texttt{Reactant}.
