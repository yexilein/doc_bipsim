...
The parsing system used by the simulator is pretty simple~\reffigp{fig:text_parser}.
...
Line format is checked token-wise by an \texttt{Interpreter}~\reffigp{fig:interpreter}.
